...
var Header = function () {
  ...
  _createClass(Header, [{
    key: "view",
    value: function view() {
      return (0, _mithril2.default)("header", (0, _mithril2.default)("a#admin-home", { href: "/admin", config: _mithril2.default.route },
...
_mithril2.default.request({
  ...
  _malatium2.default.init(_mithril2.default, store).route(document.body, "/admin", _routes2.default, "pathname");
});
